...
import EditFaqListOrder from '../../components/fi/faq/EditFaqListOrder'
import { Template } from '../TemplateClass'
import * as faqListDocs from './faqListDocs.md'

const TEMPLATE = new Template({
  originalUrl: 'zz',
  header: 'Edit FAQ List',
  template: '<edit-faq-list-order :items="computedLocalList" @update="update"></edit-faq-list-order>',
  size: 'large',
  progress: 100
}).getTemplate()
...
export const EditFaqListComponent = () => ({
  components: { EditFaqListOrder },
  template: TEMPLATE,
  computed: {
    computedLocalList () {
      return [
